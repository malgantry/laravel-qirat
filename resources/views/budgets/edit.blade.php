        ...
        <div class="form-card">
            ...
            <div class="card-body space-y-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        <h5 class="mb-1">تعديل الميزانية</h5>
                        <div class="form-sub">غيّر حد الميزانية للفئة.</div>
                    </div>
                    <button type="button" id="btn-add-cat" class="btn btn-light ms-auto d-flex align-items-center gap-1"><i class="bi bi-plus-circle"></i> فئة جديدة</button>
                    <a href="{{ route('budgets.index') }}" class="btn btn-light ms-2">عودة</a>
                </div>

    <form action="{{ route('budgets.update', $budget) }}" method="POST" class="space-y-4" novalidate>
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" name="limit_amount" class="form-control" value="{{ old('limit_amount', $budget->limit_amount) }}" required aria-required="true">
        ...
        <div class="mt-3">
            ...
            <input type="text" name="status" class="form-control" value="{{ old('status', $budget->status) }}" placeholder="نشطة / متوقفة">
        </div>
